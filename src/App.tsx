...
const htmlContet = `
<div class="container py-3 aza-price-panel">
  <header>
...
function App() {
  ...
  return (
    <div
      className="container d-flex flex-column p-5"
    ...
    >
      <Button
        ...
        icon="pi pi-check"
        pt={{
          root: { className: "btn btn-primary" },
        }}
      />
      <div style={{ width: "100%", height: "200px" }} />
      <Accordion activeIndex={0} pt={{ root: { className: "accordion" } }}>
        {tabs.map((tab, i) => {
          return (
            <AccordionTab
              key={i}
              pt={{
                ...
                toggleableContent: ({ context }) => ({
                  className: `accordion-collapse ${
                    context.selected ? "show" : "collapse"
                  }`,
                }),
              }}
              header={tab.title}
      ...
      <SelectButton
        ...
        options={["bootstrap", "ember_sharp", "ember", "silicon"]}
      />
    </div>
  );
}
